...
// Hosts
const sftpHostConfig = z
  .object({
    host: z.string(),
    credentialsID: z.string(),

    useFastPut: z.boolean().default(false),
    parallel: z.number().int().min(1).default(10),
